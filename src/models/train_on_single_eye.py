...
if __name__ == '__main__':
    ...
    # test_parameters = model_utils.test_configuration(os.path.join(os.getcwd(), "src", "models", "single_eye_model_training_runs.csv"), "single_eye_models")
    ...
    #     vgg = models.VGG_model(model_input_dim, test_num=test_num, output_parameters=2, batch_size=batch_size, directory="single_eye_models")
    #     vgg.train_model_memory(train_imgs, train_labels, val_imgs, val_labels)
    #     vgg.plot_loss_curves(directory="single_eye_models")

    # elif test_parameters["model"] == "resnet50":
    #     resnet50 = models.VGG_model(model_input_dim, test_num=test_num, output_parameters=2, batch_size=batch_size, directory="single_eye_models")
    #     resnet50.train_model_memory(train_imgs, train_labels, val_imgs, val_labels)
    #     resnet50.plot_loss_curves(directory="single_eye_models")
    
    # elif test_parameters["model"] == "inception":
    #     inception = models.VGG_model(model_input_dim, test_num=test_num, output_parameters=2, batch_size=batch_size, directory="single_eye_models")
    #     inception.train_model_memory(train_imgs, train_labels, val_imgs, val_labels)
    #     inception.plot_loss_curves(directory="single_eye_models")

    # elif test_parameters["model"] == "inception_resnet_v2":
    #     inception_resnet_v2 = models.VGG_model(model_input_dim, test_num=test_num, output_parameters=2, batch_size=batch_size, directory="single_eye_models")
    #     inception_resnet_v2.train_model_memory(train_imgs, train_labels, val_imgs, val_labels)
    #     inception_resnet_v2.plot_loss_curves(directory="single_eye_models")

    # elif test_parameters["model"] == "xception":
    #     xception = models.VGG_model(model_input_dim, test_num=test_num, output_parameters=2, batch_size=batch_size, directory="single_eye_models")
    #     xception.train_model_memory(train_imgs, train_labels, val_imgs, val_labels)
    #     xception.plot_loss_curves(directory="single_eye_models")
...
if __name__ == '__main__':
    ...
    unseen_folder = os.path.join(root_folder, "data", "processed", "mnt", "cropped_eye_imgs", "left_eye")
    ...
    if UNSEEN:
        ...
        for trial_folder in trial_folders:
            ...
            # initialise key filepaths
            save_directory = os.path.join(root_folder, "models", model_directory, "predictions", "left_eye")
